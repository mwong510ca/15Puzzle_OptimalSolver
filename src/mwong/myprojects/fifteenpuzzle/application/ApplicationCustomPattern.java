...
public class ApplicationCustomPattern {
    private static final int puzzleSize = Board.getSize();
    private static final ApplicationType applicationType = ApplicationType.CustomPattern;

    private static SolverInterface solver = new SolverPD(PDPresetPatterns.Pattern_663);
    private static HeuristicType inUsePattern = HeuristicType.PD663;
    private static int inUsePatternOption = 0;
    ...
    private static void menuChangeSolver() {
        ...
        do {
            ...
            switch (option) {
                case 0:
                    ...
                    break;
                case 1:
                    System.out.println(PDPresetPatterns.Pattern_555);
                    do {
                    ...
                    } while (!PDPresetPatterns.Pattern_555.isValidPattern(choice));

                    if (inUsePattern != HeuristicType.PD555 || inUsePatternOption != choice) {
                        solver = new SolverPD(PDPresetPatterns.Pattern_555, choice);
                    ...
                    break;
                case 2:
                    System.out.println(PDPresetPatterns.Pattern_663);
                    do {
                        System.out.println("Choose your pattern option, enter '0' for default");
                        System.out.println("Notes: If data file not exists, it takes about"
                                + " 2 minutes to generate.");
                        choice = scanner.nextInt();
                    } while (!PDPresetPatterns.Pattern_663.isValidPattern(choice));

                    if (inUsePattern != HeuristicType.PD663 || inUsePatternOption != choice) {
                        solver = new SolverPD(PDPresetPatterns.Pattern_663, choice);
                    ...
                    break;
                case 3:
                    System.out.println(PDPresetPatterns.Pattern_78);
                    do {
                        System.out.println("Choose your pattern option, enter '0' for default");
                        System.out.println("Notes: If data file not exists, it takes about"
                        ...
                        choice = scanner.nextInt();
                    } while (!PDPresetPatterns.Pattern_78.isValidPattern(choice));

                    if (inUsePattern != HeuristicType.PD78 || inUsePatternOption != choice) {
                        solver = new SolverPD(PDPresetPatterns.Pattern_78, choice);
                ...
                case 4:
                    ...
                    if (elementGroups != null) {
                        solver = null;
                        solver = new SolverPD(pattern, elementGroups);
        ...
        if (solver.getHeuristicType() == HeuristicType.PD78
                && timeoutLimit > advAccumulator.getCutoffLimit()) {
    ...
    private static boolean [] pattern2elementGroups(byte [] pattern, int maxSize) {
        ...
        boolean [] elementGroups = new boolean [PDElement.getMaxGroupSize() + 1];
    ...
    private static void menuMain() {
        ...
        do {
            ...
            if (value == 'T' || value == 't') {
                ...
                solver.setTimeoutLimit(timeoutLimit);
                if (solver.getHeuristicType() == HeuristicType.PD78) {
                    if (timeoutLimit > advAccumulator.getCutoffLimit()) {
                        flagAdvancedUpdate = true;
                    } else {
                        flagAdvancedUpdate = false;
                    }
