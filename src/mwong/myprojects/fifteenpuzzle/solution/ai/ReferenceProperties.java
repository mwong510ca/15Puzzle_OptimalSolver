 ...
 */
public final class ReferenceProperties {
  /** Default cutoff limit if property file not available. */
  private static final int DEFAULT_CUTOFF_LIMIT = 8;
  /** A set of 30 selected default reference boards, they takes 78 or 80
   *  moves to solve or longest search time. */
  ...
  /** The cutoff buffer limit in use. */
  private static int cutoffBuffer;

  static {
    final int defaultCutoff = 5;
    cutoffBuffer = defaultCutoff;
   ...
   */
  public static int getDefaultCutoffLimit() {
   ...
   */
  public static int getCutoffBuffer() {
    return cutoffBuffer;
  }
   ...
   */
  public static byte[][][] getDefaultBoards() {
